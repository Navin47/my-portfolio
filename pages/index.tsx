...
export default function Home() {
  ...
  const meta = {
    title: "Navin Jayawardena - Security Engineer",
    description: `, I safeguard digital landscapes with precision and expertise. Let's connect to discuss how I can enhance your security posture!".`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://www.navin.dev/`} />
        <link rel="canonical" href={`https://www.navin.dev/`} />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/Navin47"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
