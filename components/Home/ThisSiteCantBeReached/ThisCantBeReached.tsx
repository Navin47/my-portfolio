    ...
    >
      <div className="relative w-full flex flex-col space-y-4">
        ...
        <motion.div 
          ...
          transition={{ delay: 1, duration: 0.5 }} // Speed up animation
        ...
        >
          ...
          <motion.div
            initial={{ opacity: "100%" }}
            animate={{ opacity: "0%" }}
            transition={{ opacity: { delay: 0.5, duration: 0.2 } }} // Speed up opacity transition
            className=""
          >
          ...
          <motion.div
            ...
            transition={{ y: { delay: 2, duration: 0.5 } }}
        ...
        <motion.span
          ...
          transition={{ delay: 2, duration: 0.3 }} // Speed up text appearance
        ...
        <motion.div
          initial={{ opacity: 1 }}
          animate={{ opacity: 0 }}
          transition={{ opacity: { delay: 1.5, duration: 0.2 } }} // Speed up text fade-out
          ...
          <span className="text-gray-600 font-Header text-2xl">
            ...
            {ShowText ? (
              <motion.span
                ...
                transition={{ scale: { delay: 3, duration: 0.5 } }} // Speed up scaling
                className="font-bold"
              >
                actually can
              </motion.span>
          ...
          <span className="text-gray-500 text-md">
            ...
            {ShowText ? (
              <motion.span
                ...
                transition={{ scale: { delay: 3, duration: 1 } }} // Speed up scaling
                className="font-bold"
              >
                opened
              </motion.span>
      ...
      <motion.div
        initial={{ opacity: 1 }}
        animate={{ opacity: 0 }}
        transition={{ opacity: { delay: 1.5, duration: 0.2 } }} // Speed up button fade-out
        className=""
      >
