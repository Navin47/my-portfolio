...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
       I turn potential threats into fortified defenses
      </motion.h2>
      ...
      >
        I&apos;m a <span className="text-AAsecondary">security engineer</span>,with a sharp focus on detecting and 
        neutralizing cyber threats.I specialize  <br className="2xl:block hidden" />

        in <span className="text-AAsecondary">safeguarding</span> digital environments, actively monitoring and responding to security incidents
        <br className="2xl:block hidden"/>within a<span className="text-AAsecondary">SOC</span>.

         My work involves continuous <span className="text-AAsecondary">threat hunting</span> and  <span className="text-AAsecondary">enhancing</span>. 
        SIEM systems to protect <br className="2xl:block hidden" />
        critical assets in the ever-evolving <span className="text-AAsecondary">cybersecurity</span> landscape.
      ...
      <motion.div
        ...
        className="mt-12"
      >
        <a href={"/Navin Jayawardena CV.pdf"} target={"_blank"} rel="noreferrer">
